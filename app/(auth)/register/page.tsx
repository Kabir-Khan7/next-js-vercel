...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      await apiPost("/auth/register", { email: email.trim().toLowerCase(), password });
  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", fontFamily:"'Plus Jakarta Sans',sans-serif" }}>
      ...
      {/* Left panel */}
      <div style={{ width:"45%", background:"#060d1f", display:"flex",
        ...
        <div style={{ position:"relative", zIndex:1, textAlign:"center", maxWidth:320 }}>
          <div style={{ display:"flex", alignItems:"center", justifyContent:"center",
            ...
            <div style={{ width:40, height:40, borderRadius:10,
              background:"rgba(15,212,180,0.12)", border:"1px solid rgba(15,212,180,0.25)",
            ...
            <span style={{ fontSize:"1.3rem", fontWeight:800, color:"#f0f6ff", letterSpacing:"-0.03em" }}>
          ...
          <p style={{ fontSize:"0.82rem", color:"rgba(255,255,255,0.4)",
            ...
            Free access to professional-grade PSX stock analysis. No credit card required.
          </p>
          {[
            "Full technical analysis (20+ indicators)",
            "Buy / Hold / Sell signals",
            "Sector benchmarking vs peers",
            "Personal watchlist & alerts",
          ].map(f => (
            <div key={f} style={{ display:"flex", alignItems:"center", gap:8,
              marginBottom:8, textAlign:"left" }}>
              <span style={{ width:16, height:16, borderRadius:"50%",
                background:"rgba(15,212,180,0.15)", border:"1px solid rgba(15,212,180,0.3)",
                display:"flex", alignItems:"center", justifyContent:"center",
      ...
      <div style={{ flex:1, background:"#050c1a", display:"flex",
        ...
        <div style={{ width:"100%", maxWidth:400 }}>
          <h1 style={{ fontSize:"1.6rem", fontWeight:800, color:"#f0f6ff",
            letterSpacing:"-0.03em", margin:"0 0 6px" }}>Create account</h1>
          <p style={{ fontSize:"0.78rem", color:"rgba(255,255,255,0.35)", margin:"0 0 2rem" }}>
          ...
          <form onSubmit={handleSubmit} style={{ display:"flex", flexDirection:"column", gap:"0.9rem" }}>
            <div>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                ...
                onFocus={e => (e.target.style.borderColor = "rgba(15,212,180,0.45)")}
            ...
            <div>
              <label style={{ display:"block", fontSize:"0.7rem", fontWeight:700,
                letterSpacing:"0.06em", textTransform:"uppercase",
                color:"rgba(255,255,255,0.35)", marginBottom:6 }}>Confirm Password</label>
          ...
          <p style={{ textAlign:"center", fontSize:"0.75rem",
            ...
            <Link href="/login" style={{ color:"#0fd4b4", textDecoration:"none", fontWeight:600 }}>
              Sign in
            </Link>
          </p>
        </div>
